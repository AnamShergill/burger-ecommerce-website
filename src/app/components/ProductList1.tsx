        ...
        >
          ...
          <div className="relative flex items-center justify-center flex-grow">
            <Image
              ...
              alt={product.title}
              width={320} // Width of the image (adjust as per your design)
              height={240} // Height of the image (adjust as per your design)
            />
          </div>
